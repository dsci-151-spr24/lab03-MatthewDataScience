...
***There are `r nrow(nobel)` rows and `r ncol(nobel)` columns. Each row represents a nobel winner.***
...
***The data seems to support Buzzfeed's claim. It shows that the majority of laureates who got their award in the US were born in the US, but another significant amount were born in other countries.***
...
***Germany is the most common with 20 laureates and followed closely by Japan and the United Kingdom with 17, and 16, respectively.***
